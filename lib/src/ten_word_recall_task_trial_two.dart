...
class TenWordRecallTrialTwo extends StatefulWidget {
  ...
  @override
  TenWordRecallTrialTwoState createState() => TenWordRecallTrialTwoState();
}

class TenWordRecallTrialTwoState extends State<TenWordRecallTrialTwo> {
  ...
  void _saveCurrentScreen() {
    ...
    scoreModel.setCurrentScreen(ScreenRoutes.tenWordRecallTrialTwo);
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: ListTile(
            title: Text(
              app_data.testTenWordRecallTrialTwo,
              style: TextStyle(
                color: Colors.white,
            ...
            subtitle: Text(
              app_data.testTenWordRecallTrialTwoSubtitle,
              style: TextStyle(
                color: Colors.white,
                ...
                child: GridView.count(
                    ...
                    children: List.generate(10, (index) {
                      return TextButton(
                        ...
                        child: Text(app_data.tenWordRecallList2[index]),
                      );
                    })),
              ),
            ),
