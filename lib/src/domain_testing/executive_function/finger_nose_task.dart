...
class FingerNoseTask extends StatefulWidget {
  ...
  @override
  FingerNoseTaskState createState() => FingerNoseTaskState();
}

class FingerNoseTaskState extends State<FingerNoseTask> {
  ...
  void _loadFromModel() {
    ...
    setState(() {
      _radioValue = scoreModel.executiveFingerNose;
    });
  }

  void _saveToModel() {
    final scoreModel = MicaProviders.getScoreModel(context, listen: false);
    scoreModel.setExecutiveFingerNose(_radioValue);
  }
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
            // Purple instruction card - Task description
            SizedBox(
              width: width * 0.9,
              child: Card(
                elevation: 10.0,
            ...
            // Yellow instruction card - To patient
            SizedBox(
              width: width * 0.9,
              child: Card(
                elevation: 10.0,
            ...
            // Purple instruction card - Examiner performs variations
            SizedBox(
              width: width * 0.9,
              child: Card(
                elevation: 10.0,
