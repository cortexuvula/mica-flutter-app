...
class TapTask extends StatefulWidget {
  ...
  @override
  TapTaskState createState() => TapTaskState();
}

class TapTaskState extends State<TapTask> {
  ...
  void _saveCurrentScreen() {
    ...
    scoreModel.setCurrentScreen(ScreenRoutes.executiveTap);
  ...
  void _loadFromModel() {
    final scoreModel = MicaProviders.getScoreModel(context, listen: false);
    setState(() {
      _radioValue = scoreModel.executiveTap;
    });
  }

  void _saveToModel() {
    final scoreModel = MicaProviders.getScoreModel(context, listen: false);
    scoreModel.setExecutiveTap(_radioValue);
  }
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            // Purple instruction card - Examiner instructions
            SizedBox(
              width: width * 0.9,
              child: Card(
                elevation: 10.0,
