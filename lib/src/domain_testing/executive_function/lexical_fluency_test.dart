            ...
            SizedBox(
              ...
              child: Card(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    app_data.testExecutiveLexicalFluencyToPatient,
            ...
            SizedBox(
              ...
              child: Card(
                ...
                child: const Padding(
                  padding: EdgeInsets.all(16.0),
                  child: Text(
                    app_data.testExecutiveLexicalFluencyDetails,
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.w500,
                          ...
                          TableRow(
                            children: [
                              const Padding(
                                ...
                                child: Text(
                                  app_data
                                      .testExecutiveLexicalFluencyResponseNormal,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 11.0,
                              ...
                              const Padding(
                                ...
                                child: Text(
                                  app_data
                                      .testExecutiveLexicalFluencyResponseEquivocal,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 11.0,
                              ...
                              const Padding(
                                ...
                                child: Text(
                                  app_data
                                      .testExecutiveLexicalFluencyResponseImpaired,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 11.0,
