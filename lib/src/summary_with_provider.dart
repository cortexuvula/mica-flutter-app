...
class _TestSummaryWithProviderState extends State<TestSummaryWithProvider> {
                      ...
                      children: [
                        ...
                        TableRow(children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              valueDelayResultToString(scoreModel.scoreVerbalRecognitionMemoryTenWords),
                              textAlign: TextAlign.center,
                            ),
                          ),
                        ]),
      ...
      child: Padding(
        ...
        child: ListTile(
          ...
          onTap: () {
            ...
            Navigator.of(context).pushAndRemoveUntil(router, (Route<dynamic> route) => true);
          },
        ),
      ),
    );
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Icon(
                    Icons.brightness_1,
                    color: radioValueResultToColor(scoreModel.executiveAnimalNaming),
                  ),
                  Icon(
                    Icons.brightness_1,
  ...
  Color verbalShortTermMemory(
    ...
    bool trial3Equivocal = valuetrialThreeScore >= 5 && valuetrialThreeScore <= 7;
    ...
    if (trial2Equivocal || trial3Equivocal || stmVerbalEquivocal ||
        tenWordDelayEquivocal || recognitionEquivocal) {
      return Colors.yellow;
    } 
  ...
  String shareDoc(MicaScoreModel scoreModel) {
    ...
    shareDoc += "Disclaimer: ${appData.disclaimer2} \n\n";
    ...
    shareDoc += "  Raw score: ${3 - scoreModel.languageComprehensionRadioValue}/3\n";
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.languageComprehensionRadioValue))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(valueTrial12ResultToString(scoreModel.trialOneScore))}\n\n";

    // Short-term Memory Verbal Trial 2
    shareDoc += "Short-term Memory Verbal Trial 2: Ten Word Recall\n\n";
    shareDoc += "N > 6, E = 5 - 6, I < 5\n\n";
    shareDoc += "  Raw score: ${scoreModel.trialTwoScore}/10\n";
    shareDoc += "  ${convertResponseToString(valueTrial12ResultToString(scoreModel.trialTwoScore))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(valueTrial3ResultToString(scoreModel.trialThreeScore))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.attention))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.executiveAnimalNaming))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.executiveLuria))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.executiveSerial))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.shorttermMemoryVerbal))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.praxisRight))}\n\n";
    
    // Praxis: Finger-hand Dexterity: Left
    shareDoc += "Praxis: Finger-hand Dexterity: Left\n\n";
    shareDoc += "N = no errors, E = some difficulty, I = clear difficulty\n\n";
    shareDoc += "  Raw score: 3/3\n";
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.praxisLeft))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(valueDelayResultToString(scoreModel.tenWordDelay))}\n\n";
    ...
    shareDoc += "  ${convertResponseToString(valueDelayResultToString(scoreModel.scoreVerbalRecognitionMemoryTenWords))}\n\n";
    ...
    shareDoc += "  Raw Score: 3/3\n";
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.anomiaAgnosia))}\n\n";
    
    // Agnosia: Recognition of Line Drawings
    shareDoc += "Agnosia: Recognition of Line Drawings\n\n";
    shareDoc += "N = all correct, E = 1 error, I > 1 error\n\n";
    shareDoc += "  Raw Score: 3/3\n";
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.agnosia))}\n\n";
    
    // Executive: Design Fluency
    shareDoc += "Executive: Design Fluency\n\n";
    shareDoc += "N > 7 drawings, E = 5 - 7 drawings, I < 5 drawings\n\n";
    shareDoc += "  Raw Score: 3/3\n";
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.executive))}\n\n";
    
    // Spoken Language
    shareDoc += "Spoken Language\n\n";
    shareDoc += "N = normal speech, E = equivocal, I definite impairment\n\n";
    shareDoc += "  Raw Score: 3/3\n";
    shareDoc += "  ${convertResponseToString(radioValueResultToString(scoreModel.spokenLanguage))}\n\n";
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          ...
          widgets.add(
            pw.Paragraph(
              text: "Disclaimer: ${appData.disclaimer2}",
          ...
          widgets.add(
            pw.Paragraph(
              text: "Name: ${scoreModel.patientName.isNotEmpty ? scoreModel.patientName[0].toUpperCase() + scoreModel.patientName.substring(1) : ''}",
            )
          );
          ...
          widgets.add(
            pw.Paragraph(
              text: "Assessor: ${scoreModel.assessorName.isNotEmpty ? scoreModel.assessorName[0].toUpperCase() + scoreModel.assessorName.substring(1) : ''}",
            )
          );
          ...
          widgets.add(addAssessmentSection(
            ...
            guide: "",
            rawScore: "Raw score: ${3 - scoreModel.languageComprehensionRadioValue}/3",
            result: convertResponseToString(radioValueResultToString(scoreModel.languageComprehensionRadioValue))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            result: convertResponseToString(valueTrial12ResultToString(scoreModel.trialOneScore))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            result: convertResponseToString(valueTrial12ResultToString(scoreModel.trialTwoScore))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            result: convertResponseToString(valueTrial3ResultToString(scoreModel.trialThreeScore))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            rawScore: "Raw score: ${scoreModel.attentionCorrect} Correct Taps\nRaw score: ${scoreModel.attentionMistakes} Incorrect Taps",
            result: convertResponseToString(radioValueResultToString(scoreModel.attention))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            result: convertResponseToString(radioValueResultToString(scoreModel.executiveAnimalNaming))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            result: convertResponseToString(radioValueResultToString(scoreModel.executiveLuria))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            result: convertResponseToString(radioValueResultToString(scoreModel.executiveSerial))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            result: convertResponseToString(radioValueResultToString(scoreModel.shorttermMemoryVerbal))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            result: convertResponseToString(radioValueResultToString(scoreModel.praxisRight))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            guide: "N = no errors, E = some difficulty, I = clear difficulty",
            rawScore: "Raw score: 3/3",
            result: convertResponseToString(radioValueResultToString(scoreModel.praxisLeft))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            result: convertResponseToString(valueDelayResultToString(scoreModel.tenWordDelay))
          ));
          
          widgets.add(addAssessmentSection(
            title: "Short-Term Memory Verbal Recognition: Total Score",
            guide: "N > 5, E = 5, I < 5",
            rawScore: "Raw score: Words correctly identified in original word list: ${scoreModel.scoreVerbalRecognitionMemoryTenWordsInList}/10\nRaw score: Words correctly identified NOT in original word list: ${scoreModel.scoreVerbalRecognitionMemoryTenWordsNotInList}/10\nRaw score: Words identified: ${scoreModel.scoreVerbalRecognitionMemoryTenWords}/20",
            result: convertResponseToString(valueDelayResultToString(scoreModel.scoreVerbalRecognitionMemoryTenWords))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            rawScore: "Raw Score: 3/3",
            result: convertResponseToString(radioValueResultToString(scoreModel.anomiaAgnosia))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            guide: "N = all correct, E = 1 error, I > 1 error",
            rawScore: "Raw Score: 3/3",
            result: convertResponseToString(radioValueResultToString(scoreModel.agnosia))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            rawScore: "Raw Score: 3/3",
            result: convertResponseToString(radioValueResultToString(scoreModel.executive))
          ));
          ...
          widgets.add(addAssessmentSection(
            ...
            rawScore: "Raw Score: 3/3",
            result: convertResponseToString(radioValueResultToString(scoreModel.spokenLanguage))
          ));
